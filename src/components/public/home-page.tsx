...
export function HomePage({
  ...
  return (
    <main id="main-content">
      <section className="bg-burgundy text-ivory relative isolate flex min-h-[92svh] items-end overflow-hidden pt-36 pb-16 sm:pb-20 lg:min-h-[min(94svh,60rem)] lg:pb-24">
        ...
        <Container className="relative">
          <div className="max-w-5xl">
            ...
            <div className="border-ivory/15 mt-10 flex max-w-3xl flex-col gap-7 border-t pt-7 sm:flex-row sm:items-end sm:justify-between">
              <p className="text-ivory/72 max-w-xl text-base leading-8 sm:text-lg">
                {home.intro}
              </p>
              <Link
      ...
      <section className="bg-burgundy text-ivory relative overflow-hidden py-20 sm:py-28 lg:py-36">
        <div className="lacquer-grain" aria-hidden="true" />
        <Container className="relative">
          <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
            <SectionHeading
      ...
      <section className="bg-charcoal text-ivory py-20 sm:py-28 lg:py-36">
      ...
      <section className="bg-lacquer text-ivory py-20 sm:py-28">
