...
const dictionary = {
  ...
  contact: {
    ...
    countryPlaceholder: "e.g. United States, Japan, France",
    requestType: "Request type",
    requestTypeSelect: "Select a request type",
    requestTypes: {
      existing_products: "Quote for catalogue products",
      custom_design: "Custom design / OEM",
      samples: "Sample order",
      catalogue: "Catalogue and price list",
      other: "Other",
    },
    items: "Products of interest",
    itemsSearch: "Search products by name…",
    itemsHint: "Pick from the catalogue or type the product you need.",
    itemsAddCustom: "Add another product",
    itemsEmpty: "This product is already on the list.",
    itemQuantity: "Quantity",
    itemRemove: "Remove",
    estimatedQuantity: "Total estimated quantity",
    budget: "Budget or target price",
    budgetPlaceholder: "e.g. USD 8–10 per piece",
    deadline: "Desired delivery date",
    deliveryTerms: "Delivery terms",
    deliveryTermsSelect: "Select delivery terms",
    deliveryTermOptions: {
      EXW: "EXW – ex works",
    ...
    destinationPlaceholder: "City or port of arrival",
    message: "Describe your request",
    messagePlaceholder:
      "Sizes, colours, motifs, packaging, logo printing, intended use…",
    consent:
    ...
    successDescription:
      "Thank you. We will reply by email within one to two working days. A confirmation has been sent to your inbox.",
    requestCode: "Request code",
    errorInvalid: "Please check the required fields.",
    errorRateLimited:
      "You have sent several requests in a row. Please try again in a few minutes.",
    errorUnavailable:
      "We could not send your request right now. Please try again or email us.",
    mapTitle: "Map",
    mapUnavailable:
