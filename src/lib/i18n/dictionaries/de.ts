...
const dictionary = {
  ...
  contact: {
    ...
    requestTypeSelect: "Art der Anfrage auswählen",
    requestTypes: {
      existing_products: "Angebot für Katalogprodukte",
      custom_design: "Sonderanfertigung / OEM",
      samples: "Musterbestellung",
      catalogue: "Katalog und Preisliste",
      other: "Sonstiges",
    },
    items: "Gewünschte Produkte",
    itemsSearch: "Produkt nach Name suchen…",
    itemsHint: "Aus dem Katalog wählen oder das gewünschte Produkt eintragen.",
    itemsAddCustom: "Weiteres Produkt hinzufügen",
    itemsEmpty: "Dieses Produkt steht bereits auf der Liste.",
    itemQuantity: "Menge",
    itemRemove: "Entfernen",
    estimatedQuantity: "Geschätzte Gesamtmenge",
    budget: "Budget oder Zielpreis",
    budgetPlaceholder: "z. B. 8–10 USD pro Stück",
    deadline: "Gewünschter Liefertermin",
    deliveryTerms: "Lieferbedingungen",
    deliveryTermsSelect: "Lieferbedingungen auswählen",
    deliveryTermOptions: {
      EXW: "EXW – ab Werk",
    ...
    destinationPlaceholder: "Stadt oder Zielhafen",
    message: "Beschreiben Sie Ihre Anfrage",
    messagePlaceholder:
      "Maße, Farben, Motive, Verpackung, Logodruck, Verwendungszweck…",
    consent:
    ...
    successDescription:
      "Vielen Dank. Wir antworten innerhalb von ein bis zwei Werktagen per E-Mail. Eine Bestätigung wurde an Ihr Postfach gesendet.",
    requestCode: "Anfragenummer",
    errorInvalid: "Bitte prüfen Sie die Pflichtfelder.",
    errorRateLimited:
      "Sie haben mehrere Anfragen hintereinander gesendet. Bitte versuchen Sie es in einigen Minuten erneut.",
    errorUnavailable:
      "Die Anfrage konnte gerade nicht gesendet werden. Bitte erneut versuchen oder per E-Mail schreiben.",
    mapTitle: "Karte",
    mapUnavailable:
