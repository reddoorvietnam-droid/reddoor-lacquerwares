...
const dictionary = {
  ...
  contact: {
    ...
    sectionRequest: "Nhu cầu báo giá",
    ...
    countryPlaceholder: "Ví dụ: Việt Nam, Japan, France",
    requestType: "Loại yêu cầu",
    requestTypeSelect: "Chọn loại yêu cầu",
    requestTypes: {
      existing_products: "Báo giá sản phẩm có sẵn",
      custom_design: "Thiết kế riêng / OEM theo yêu cầu",
      samples: "Đặt mẫu thử",
      catalogue: "Xin catalogue và bảng giá",
      other: "Khác",
    },
    items: "Sản phẩm quan tâm",
    itemsSearch: "Tìm sản phẩm theo tên…",
    itemsHint: "Chọn từ catalogue hoặc nhập tên sản phẩm bạn cần.",
    itemsAddCustom: "Thêm sản phẩm khác",
    itemsEmpty: "Sản phẩm này đã có trong danh sách.",
    itemQuantity: "Số lượng",
    itemRemove: "Bỏ",
    estimatedQuantity: "Tổng số lượng dự kiến",
    budget: "Ngân sách hoặc giá mục tiêu",
    budgetPlaceholder: "Ví dụ: 8–10 USD/chiếc",
    deadline: "Thời hạn nhận hàng mong muốn",
    deliveryTerms: "Điều kiện giao hàng",
    deliveryTermsSelect: "Chọn điều kiện giao hàng",
    deliveryTermOptions: {
    ...
    destinationPlaceholder: "Thành phố hoặc cảng đến",
    message: "Mô tả yêu cầu",
    messagePlaceholder:
      "Kích thước, màu sắc, hoạ tiết, bao bì, in logo, mục đích sử dụng…",
    consent:
    ...
    successDescription:
      "Cảm ơn bạn. Chúng tôi sẽ phản hồi qua email trong vòng 1–2 ngày làm việc. Một bản xác nhận đã được gửi tới hộp thư của bạn.",
    requestCode: "Mã yêu cầu",
    errorInvalid: "Vui lòng kiểm tra lại các trường bắt buộc.",
    errorRateLimited:
      "Bạn vừa gửi nhiều yêu cầu liên tiếp. Vui lòng thử lại sau ít phút.",
    errorUnavailable:
      "Không gửi được lúc này. Vui lòng thử lại hoặc gửi email cho chúng tôi.",
    mapTitle: "Bản đồ",
    mapUnavailable:
