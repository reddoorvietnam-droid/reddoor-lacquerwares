...
- Brand copy, product/collection/news records, media frames, policies, map/contact details, process facts, and About highlights are clearly labelled development placeholders awaiting approved source material.
- The quote form is intentionally non-submitting. No DEMO fixture constitutes persistence, an authorized CMS workflow, or a completed business workflow.

### Not yet implemented

- MongoDB content persistence/publishing, complete SEO, Cloudinary uploads, flipbook processing/viewing, authentication, RBAC, audit logging, quote/order flows, inventory, production, finance, documents, reports, notifications, and deployment integration.
